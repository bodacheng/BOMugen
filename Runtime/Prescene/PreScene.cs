...
namespace mainMenu
{
    public partial class PreScene : MonoBehaviour
    {
        ...
        void BasicPhase()
        {
            ...
            var arcadeFrontPage = new ArcadeFrontPage(ArcadeModeManager.Instance);
            var gangbangFrontPage = new GangbangFrontPage(GangbangModeManager.Instance);
            var eventFrontPage = new EventFightPage(EventModeManager.Instance);

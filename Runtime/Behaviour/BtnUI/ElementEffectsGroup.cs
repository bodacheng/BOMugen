...
public class ElementEffectsGroup
{
    ...
    {
        var targetPos = PosCal.GetWorldPos(FightScene.target.fxCamera, targetBtn.GetComponent<RectTransform>(), 7);
    ...
    public void BtnRefreshEffect()
    {
        ...
        {
            pair.Value.transform.position = PosCal.GetWorldPos(FightScene.target.fxCamera, pair.Key.GetComponent<RectTransform>(),4);

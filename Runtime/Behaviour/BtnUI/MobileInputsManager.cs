...
public class MobileInputsManager : MonoBehaviour {
    ...
    void SwitchElementEffects(Element element)
    {
        ...
        if (_elementEffects.ContainsKey(element))
        {
            ...
            _elementEffects[element].Open(
                PosCal.GetWorldPos(FightScene.target.fxCamera, defendBtn.GetComponent<RectTransform>(), 5), 
                PosCal.GetWorldPos(FightScene.target.fxCamera, dashBtn.GetComponent<RectTransform>(), 5),
                PosCal.GetWorldPos(FightScene.target.fxCamera, dreamComboBtn.GetComponent<RectTransform>(), 5)
            );
        }else{
    ...
    public void SkillExplosion(InputKey key, int spLevel)
    {
        ...
        switch (key)
        {
            case InputKey.Attack1:
                targetExplode.transform.position = PosCal.GetWorldPos(FightScene.target.fxCamera, a1Btn.GetComponent<RectTransform>(), 3);
                break;
            case InputKey.Attack2:
                targetExplode.transform.position = PosCal.GetWorldPos(FightScene.target.fxCamera, a2Btn.GetComponent<RectTransform>(), 3);
                break;
            case InputKey.Attack3:
                targetExplode.transform.position = PosCal.GetWorldPos(FightScene.target.fxCamera, a3Btn.GetComponent<RectTransform>(), 3);
                break;
            case InputKey.DreamCombo:
                targetExplode.transform.position = PosCal.GetWorldPos(FightScene.target.fxCamera, dreamComboBtn.GetComponent<RectTransform>(), 3);
                break;
        }
        targetExplode?.Play();
    }
    ...
    {
        Vector3 targetPos = PosCal.GetWorldPos(FightScene.target.fxCamera, button.GetComponent<RectTransform>(), 5);

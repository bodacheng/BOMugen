...
{
    // 随机技能组
    public static SkillSet RandomSkillSet(string type, string originSkill, bool baseOnAcc, StoneFilterForm filterForm = null, bool noSpLimit = false)
    {
    ...
    static StoneFilterForm DecideRemainForm(SkillSet skillSet, string type, StoneFilterForm form, int targetSlot, bool noSpLimit = false)
    {
        if (noSpLimit)
        {
            return form;
    ...
    /// <returns></returns>
    static SkillSet RandomSkillSetRec(string type, SkillSet skillSet, List<int> remainSlots, SkillConfig origin, bool baseOnAcc, StoneFilterForm filterForm, bool noSpLimit = false)
    {
